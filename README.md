...
A modular and production‑style implementation of a **Probability of Default (PD)** prediction model using **Logistic Regression**.  
This project generates synthetic credit data, trains a PD model, evaluates performance, and visualizes the ROC curve.
